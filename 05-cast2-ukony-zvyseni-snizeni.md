# Část druhá — Úkony právní služby a úpravy mimosmluvní odměny (§§ 11–12b)

> **Téma kapitoly:** Tato kapitola vykládá pravidla pro stanovení **úkonů právní služby** jako základní výpočtové jednotky mimosmluvní odměny. Rozlišuje **plný úkon** (§ 11 odst. 1) od **polovičního úkonu** (§ 11 odst. 2) a stanoví pravidlo **analogie úkonů** (§ 11 odst. 3) pro případy, které výslovný výčet nepokrývá. Dále upravuje možnost **zvýšení odměny až na trojnásobek** a **snížení odměny** advokátem (§ 12 odst. 1 a 2), způsob výpočtu odměny při spojení věcí (§ 12 odst. 3), zvláštní pravidlo pro **společné úkony při zastupování více osob** se stupňovitým snižováním za druhou a každou další osobu (§ 12 odst. 4), a pravidlo pro obhajobu při **souběhu trestných činů** (§ 12 odst. 5). Samostatný § 12b pak stanoví paušální sazby za **právní poradu dle § 18a a § 18b zákona o advokacii** (bezplatná právní pomoc určeným advokátem).
...
**Systematika § 11 — úkon jako výpočtová jednotka**

Paragraf 11 tvoří jádro celého systému mimosmluvní odměny. Zatímco §§ 6–10 (viz `03-cast2-mimosmluvni-vyse-sazba-tarifni-hodnota.md`) stanoví výši sazby za jeden úkon v závislosti na tarifní hodnotě věci, § 11 určuje, jaké faktické úkony advokáta se jako plnohodnotný nebo poloviční úkon vůbec počítají. Mimosmluvní odměna se tedy vypočítá jako součin počtu úkonů právní služby a příslušné sazby (případně upravené dle § 12).

Zákon nepodává obecnou definici pojmu „úkon právní služby"; advokátní tarif jej tedy vymezuje výčtem. Výčet v odst. 1 a 2 je taxativní co do pojmenovaných kategorií, avšak nikoli vyčerpávající, neboť odst. 3 výslovně zavádí analogii pro nepojmenované úkony (viz níže).

**Judikatura (z místních zdrojů):**

- *NS* [1 Tmo 17/2022](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/D9B6B6B9556F8C63C12589DD002C1C1E?openDocument) — 24. 10. 2022, kat. A
  > „Odměna advokáta, Zákaz reformace in peius § 150 odst. 1, § 151 odst. 3, 6 tr. ř. I. Do výroku usnesení, jímž se podle § 151 odst. 3, 6 tr. ř. stanoví odměna obhájce nebo zmocněnce poškozeného a zúčastněné osoby, náhrada jeho hotových výdajů, náhrada za promeškaný čas a daň z přidané hodnoty, postačí uvést souhrnné částky, které je stát povinen advokátovi uhradit na těchto nárocích. Výčet jednotlivých úkonů, za které advokátovi přísluší odměna, a náhrad s nimi souvisejících postačí specifikovat a podřadit pod příslušné ustanovení advokátního tarifu až v odůvodnění daného usnesení. Při rozhodování o stížnosti advokáta proti takovému usnesení je z hlediska zákazu reformace in peius ve smyslu § 150 odst. 1 tr. ř. určující celková výše jemu přiznané odměny a náhrad (tj. jejich součet). Advokátní tarif § 11 odst. 1, 2, 3 advokátního tarifu II. Vzdání se odvolání samo o sobě není úkonem…"
- *NS* [1 Tmo 12/2022](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/072A7D926CBAF906C125899400372045?openDocument) — 26. 8. 2022, kat. A
...
- *NS* [6 To 99/2021](https://rozhodnuti.nsoud.cz/judikatura/judikatura_ns.nsf/zip?openAgent&query=%5Bdatum_predani_na_web%5D%3E%3D01.01.2022%20AND%20%5Bdatum_predani_na_web%5D%3C%3D31.12.2022&SearchOrder=1&SearchMax=0&start=2040&count=60&pohled=#rozhodnuti-6_To_99_2021.txt) — 7. 4. 2021, kat. A
...
- *NS* [4 To 32/2021](https://rozhodnuti.nsoud.cz/judikatura/judikatura_ns.nsf/zip?openAgent&query=%5Bdatum_predani_na_web%5D%3E%3D01.01.2022%20AND%20%5Bdatum_predani_na_web%5D%3C%3D31.12.2022&SearchOrder=1&SearchMax=0&start=2040&count=60&pohled=#rozhodnuti-4_To_32_2021.txt) — 15. 3. 2021, kat. A
...
- *NS* [17 Co 394/2007](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/6DA8EE3087DC9949C1257BD60046AFE5?openDocument) — 19. 9. 2007, kat. A
...
- *NS* [4 Tz 4/2006](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/4069A8B4959AF6D7C1257A4E0069710A?openDocument) — 16. 2. 2006, kat. A
...
**Odstavec 1 — plné úkony právní služby (písm. a–o)**

*Písm. a) — převzetí a příprava zastoupení nebo obhajoby (smluvní zastoupení)*

Jde o první a zpravidla jednorázový úkon, který pokrývá přijetí věci advokátem, studium podkladů předaných klientem a přípravu na vstup do případu. Podmínkou je uzavření smlouvy o poskytnutí právních služeb (§ 51 zákona o advokacii). Tento úkon se odlišuje od písm. b), které dopadá na ustanovené zastoupení: tam je první porada s klientem a příprava zastoupení sloučena do jednoho úkonu právě proto, že advokát nemá předchozí kontakt s klientem a součástí úkonu je i samotná první porada.

*Písm. b) — první porada s klientem včetně převzetí a přípravy zastoupení (ustanovené zastoupení)*

Dopadá na situaci, kdy advokát není zvolen klientem dobrovolně, ale je mu ustanoven soudem (§ 30 o. s. ř., § 35 odst. 8 z. ř. s., § 38 tr. ř. aj.). Protože klient si advokáta nezvolil a mezi nimi není předchozí vztah, tarif slučuje první poradu s přípravou zastoupení do jednoho plného úkonu. U smluvního zastoupení se první porada s klientem jako samostatný úkon neuvádí — je implicitně zahrnuta v písm. a), nebo ji lze v závislosti na délce považovat za poradu dle písm. c).

*Písm. c) — další porada s klientem přesahující jednu hodinu*

Každá porada s klientem (jiná než ta popsaná v písm. b), resp. první po převzetí věci) zakládá nárok na odměnu pouze tehdy, přesáhne-li délku jedné hodiny. Porada do jedné hodiny se tedy jako samostatný úkon nepočítá — nevylučuje to samozřejmě smluvní ujednání o odměně. Hodina v tomto kontextu je interpretována jako 60 minut skutečné doby porady; u porady přesahující jednu hodinu náleží za ni jeden plný úkon bez ohledu na její skutečnou délku (neplatí zde princip každých dalších započatých dvou hodin, který platí u úkonů e), f), g) a i)).

*Písm. d) — písemné podání nebo návrh ve věci samé; výzva k plnění se skutkovým a právním rozborem*

Toto písmeno pokrývá dvě skupiny: (i) klasická procesní podání rozhodující o věci samé (žaloba, odpor, vyjádření k žalobě, replika, duplika, pokud jde o meritorní procesní úkony) a (ii) předžalobní výzva k plnění, která musí obsahovat nejen výzvu samotnou, ale i základní skutkový a právní rozbor věci — tím se liší od prosté výzvy, která je jen polovičním úkonem dle odst. 2 písm. h). Podmínka „ve věci samé" vylučuje procesní podání procesní povahy (např. žádosti o prodloužení lhůty, sdělení o plné moci), která se zpravidla přiřadí dle analogie k nejbližšímu úkonu nebo se jako samostatný úkon vůbec nepočítají.

*Písm. e) — účast při vyšetřovacích úkonech v přípravném řízení (á 2 hodiny)*

Typicky se jedná o výslech obviněného, výslech svědka za přítomnosti obhájce, rekognici, konfrontaci či ohledání místa činu v přípravném řízení trestním. Za každé započaté dvě hodiny takové účasti náleží jeden plný úkon. Princip „každé započaté dvě hodiny" znamená, že i zlomek čtyřicáté třetí minuty přes dvouhodinovou hranici zakládá nárok na druhý úkon.

*Písm. f) — prostudování spisu při skončení vyšetřování (á 2 hodiny)*
...
Zvláštní kategorií je účast při jednání, při němž došlo pouze k vyhlášení rozhodnutí — ta je výslovně zařazena mezi úkony poloviční (odst. 2 písm. f), protože advokát se na takové jednání fakticky nepřipravuje a trvá řádově jen několik minut.

*Písm. h) — sepsání právního rozboru věci*

Právní rozbor (analýza věci, due diligence, stanovisko) je samostatným plným úkonem bez ohledu na svou délku — na rozdíl od porad a jednání zde není hodinový princip. Rozborem se rozumí systematické písemné posouzení právní problematiky: výklad rozhodného práva, subsumpce skutkových okolností, závěr a doporučení. Pouhé sdělení názoru ústně nebo krátkým e-mailem se za písemný právní rozbor zpravidla nepovažuje.

*Písm. i) — jednání s protistranou (á 2 hodiny)*

Přímé jednání (osobní, telefonické, videokonferencí) s protistranou nebo jejím zástupcem, jehož cílem je dosažení dohody, smíru nebo jiného výsledku. Princip každých dvou započatých hodin platí i zde. Pozornost je třeba věnovat odlišení od porady s klientem (písm. c): advokát musí fakticky jednat s protistranou, nikoliv jen s klientem o taktice.

*Písm. j) — návrh na předběžné opatření před zahájením řízení; odvolání proti rozhodnutí o PO a vyjádření*
...
Zahrnuje sepisování smluv, jednostranných právních jednání, plných mocí se složitějším obsahem, notářských zápisů (za součinnosti advokáta), zakladatelských dokumentů obchodních společností apod. Každá samostatně sepsaná listina je jedním úkonem. Pokud advokát sepisuje rozsáhlý soubor smluv v jedné transakci, posoudí se, zda jde o jednu transakci (jeden úkon) nebo o více samostatných právních jednání.

*Písm. n) — stížnost proti usnesení o zahájení trestního stíhání*
...
**Odstavec 2 — poloviční úkony právní služby (písm. a–h)**

Odstavec 2 vyjmenovává úkony, za které náleží odměna ve výši *jedné poloviny* sazby stanovené dle §§ 7–9 (pro příslušnou tarifní hodnotu nebo typ věci). Logika zařazení spočívá v nižší náročnosti, procesně podřadném postavení nebo opakujícím se charakteru daného úkonu.
...
Tyto procesní návrhy mají zpravidla formalizovaný charakter a nevyžadují rozsáhlou argumentaci ve věci samé; jsou proto honorovány poloviční odměnou.

*Písm. c) — odvolání proti rozhodnutí, které není rozhodnutím ve věci samé*

Například odvolání proti usnesení o nákladech řízení, usnesení o procesních otázkách. Pokud je napadeno rozhodnutí ve věci samé, platí plný úkon dle odst. 1 písm. k).

*Písm. d) — návrhy a stížnosti ve věcech rozhodovaných ve veřejném zasedání (s výjimkami)*

Dopadá na trestní věci, kde se veřejné zasedání koná pro rozhodnutí procesní povahy (např. přerušení výkonu trestu, podmíněné propuštění) — s výjimkami výslovně uvedenými (odvolání, návrh na obnovu, podnět ke stížnosti pro porušení zákona jsou plnými úkony).

*Písm. e) — věci výkonu rozhodnutí (exekuční věci)*
...
Výzva k plnění bez podrobnějšího skutkového a právního rozboru (na rozdíl od písm. d) odst. 1, kde musí výzva takový rozbor obsahovat). Typicky jde o standardizovanou předžalobní upomínku.

---

**Odstavec 3 — analogie úkonů**

Výčet v odst. 1 a 2 nemůže pokrýt veškerou rozmanitost advokátní praxe. Odst. 3 proto stanoví pravidlo analogie: za úkony právní služby, které ve výčtu uvedeny nejsou, náleží odměna jako za úkon, jemuž jsou svou **povahou** (tj. charakterem a obsahem) a **účelem** (tj. procesní nebo hmotněprávní funkcí) nejbližší. Analogie je závazná jak pro advokáta, tak pro soud při rozhodování o náhradě nákladů řízení. V pochybnostech se přiklání k tomu úkonu, který je funkčně nejsrovnatelnější — nikoliv k tomu, který je pro advokáta nejvýhodnější nebo pro klienta nejlevnější.
...
**Odstavec 1 — zvýšení mimosmluvní odměny až na trojnásobek**

Základní sazba mimosmluvní odměny stanovená dle §§ 6–10 advokátního tarifu vychází z průměrné náročnosti věci dané tarifní hodnoty. Paragraf 12 odst. 1 umožňuje tuto sazbu zvýšit, jestliže jsou splněny kvalifikované předpoklady:

- **Mimořádná obtížnost** věci — tato podmínka je obecná a zahrnuje zejména (příklady nejsou taxativní):
  - nutnost použití **cizího práva** (mezinárodní právo soukromé, unijní právo aplikované přímo, cizí hmotněprávní řád dle kolizní normy);
  - nutnost jednání nebo zpracování dokumentů v **cizím jazyce** (překlad, tlumočení, komunikace s cizím soudem nebo arbitráží);
- **Časová náročnost** věci — věci, jejichž skutkový nebo právní rámec vyžaduje nepřiměřeně mnoho práce v poměru k tarifní hodnotě (např. složitá hospodářská trestní věc s nízkou nominální škodou, ale tisíci stranami spisu).

Maximální zvýšení je trojnásobek základní sazby. Zvýšení je fakultativní — „může advokát zvýšit" — a náleží advokátovi jako jejich jednostranné právo v rámci mimosmluvní odměny. U smluvní odměny se toto ustanovení neuplatní (strany se dohodly jinak). Pokud soud přiznává náhradu nákladů řízení, posoudí přiměřenost zvýšení samostatně — prokázaná mimořádná obtížnost musí být doložena (např. cizojazyčná korespondence, použité zahraniční prameny, objem spisu).

**Odstavec 2 — snížení mimosmluvní odměny až o polovinu**

Advokát může mimosmluvní odměnu snížit, a to až o polovinu základní sazby. Důvodem může být nižší skutečná náročnost věci (typizovaná věc, standardní postup), charitativní přístup k určitému klientu nebo jiné individuální okolnosti.

Zásadní omezení: **§ 12 odst. 2 (snížení odměny) se nepoužije** ve dvou situacích (viz § 1 odst. 2 a 3 advokátního tarifu, podrobněji kapitola `01-cast1-obecna-ustanoveni.md`):

1. **Při rozhodování o náhradě nákladů řízení** — soud (nebo jiný orgán) při určení výše odměny, která se protistraně přiznává k náhradě, vychází z mimosmluvní odměny v plné výši dle tarifu; nelze přiznat nižší odměnu jen proto, že advokát vítěze svého klienta zastupoval za nižší cenu.
2. **U advokáta ustanoveného soudem** — odměna ustanoveného advokáta hrazená státem se rovněž určuje v plné výši mimosmluvní sazby bez možnosti snížení dle odst. 2.

Tato omezení chrání jak protistranu (aby za ni neplatila méně, než na co má vítěz právo), tak ustanoveného advokáta (jehož odměna hrazená státem nesmí být krácena).

**Odstavec 3 — spojení věcí: součet tarifních hodnot**

Jsou-li věci spojeny ke společnému projednání na základě procesní dispozice stran nebo soudu, aniž by jejich spojení vyplývalo přímo z jiného právního předpisu, nestanoví se tarifní hodnota pro každou věc zvlášť, ale jako součet tarifních hodnot všech spojených věcí. To zvyšuje celkovou sazbu za úkon (jde do vyššího pásma tabulky dle § 7 nebo § 9), avšak na druhou stranu koresponduje se zvýšenou náročností spojeného řízení. Pokud je spojení nařízeno ex lege (např. spojení věcí z důvodu věcné nebo subjektivní kumulace dané přímo procesním předpisem), toto pravidlo se nepoužije.

**Odstavec 4 — společné úkony při zastupování více osob: stupňovité snížení**

Jestliže advokát zastupuje nebo obhajuje více osob a provede pro ně tentýž úkon (tj. úkon je společný — typicky jedno podání soudu, jedno jednání), odměna za stejný úkon vůči druhé a každé další osobě se snižuje. Základní odměna za první osobu zůstává plná.

| Pořadí zastupované osoby | Snížení odměny | Výše odměny (% z plné sazby) |
|---|---|---|
| 1. osoba | žádné | 100 % |
| 2. osoba | o 20 % | 80 % |
| 3. osoba | o 40 % | 60 % |
| 4. osoba | o 60 % | 40 % |
| 5. osoba a každá další | o 80 % | 20 % |

**Příklad výpočtu:** Advokát zastupuje v jedné civilní věci čtyři žalobce (společné procesní úkony). Sazba za jeden úkon při tarifní hodnotě věci činí 5 000 Kč. Advokát podá jedno písemné podání ve věci samé (§ 11 odst. 1 písm. d). Celková odměna za tento úkon:

- 1. žalobce: 5 000 Kč × 100 % = **5 000 Kč**
- 2. žalobce: 5 000 Kč × 80 % = **4 000 Kč**
- 3. žalobce: 5 000 Kč × 60 % = **3 000 Kč**
- 4. žalobce: 5 000 Kč × 40 % = **2 000 Kč**
- **Celkem za úkon: 14 000 Kč**

Pravidlo reflektuje skutečnost, že při zastupování více osob v téže věci je přípravná i realizační práce sdílena — advokát připraví jedno podání, které platí pro všechny klienty, a marginální náklady na každého dalšího klienta jsou proto nižší než u zastoupení první osoby. Podmínkou je, aby úkon byl skutečně „společný" — tj. aby šlo o jeden procesní nebo hmotněprávní úkon, nikoliv o souběh samostatných věcí.

**Odstavec 5 — souběh trestných činů: odměna dle nejvyšší trestní sazby**

V trestní věci, kde je obviněný stíhán pro více trestných činů spáchaných v souběhu (ideálním nebo reálném), se odměna advokáta neurčuje součtem odměn za každý trestný čin zvlášť, ale jen jednou — a to dle trestného činu s **nejvyšší trestní sazbou**. Výše trestní sazby rozhodné pro určení tarifní hodnoty trestní věci (srov. § 10 advokátního tarifu a kapitolu `03-cast2-mimosmluvni-vyse-sazba-tarifni-hodnota.md`) je tak limitována maximem za nejtěžší z trestných činů. Toto pravidlo zabraňuje násobnému navyšování odměny u vícečinného souběhu, kde advokát vede ve skutečnosti jediné řízení.

**Judikatura (z místních zdrojů):**

- *NS* [25 Cdo 1552/2025](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/5A2ECFB8924B1D27C1258D7F0052C3AC?openDocument) — 16. 12. 2025, kat. A
...
- *NS* [4 To 551/2023](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/7D39061364D5BE97C1258C210048B01F?openDocument) — 7. 12. 2023, kat. A
...
- *NS* [50 To 514/2009](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/AA918BEDD198EAE7C1257A4E006A478E?openDocument) — 9. 11. 2009, kat. A
...
**Systematický kontext — bezplatná právní pomoc**
...
**Sazba dle § 18a: 200 Kč/půlhodina**

Za každou i jen **započatou půlhodinu** porady poskytnuté dle § 18a zákona o advokacii náleží advokátovi 200 Kč. Princip „každé i jen započaté" půlhodiny (nikoliv celé) je výhodný pro advokáta — i porada trvající například 35 minut zakládá nárok na 2 × 200 Kč = 400 Kč. Tato sazba je pevná (paušální) a neodvíjí se od tarifní hodnoty věci ani od § 7–10 tarifu; nevztahuje se na ni zvýšení ani snížení dle § 12 (§ 12b je speciální ustanovení).

**Sazba dle § 18b: 400 Kč/hodina**

Za každou i jen **započatou hodinu** porady poskytnuté dle § 18b zákona o advokacii náleží 400 Kč. Časová jednotka je dvojnásobná oproti § 18a (hodina namísto půlhodiny), ale paušální sazba je rovněž dvojnásobná — výsledná sazba za hodinu porady je tak v obou případech srovnatelná (200 Kč/30 min = 400 Kč/60 min). Rozdíl v délce časové jednotky má praktický dopad při kratších poradách: porada trvající 25 minut bude dle § 18a honorována jako jedna půlhodina (200 Kč), zatímco dle § 18b jako jedna hodina (400 Kč).
...
*Viz také: `01-cast1-obecna-ustanoveni.md` (§ 1 — vymezení subjektů a použití tarifu, § 1 odst. 2 a 3 — omezení snížení odměny), `03-cast2-mimosmluvni-vyse-sazba-tarifni-hodnota.md` (§§ 6–10 — sazby a tarifní hodnoty), `06-cast3-6-nahrady-dph-naklady-zaver.md` (náhrady hotových výdajů a DPH), `INDEX.md` (přehled celého komentáře).*
